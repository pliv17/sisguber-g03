...
use App\Modules\Maestros\Repositories\CatalogProductRepository;
...
final class CatalogProductService
{
    public function __construct(
        private readonly CatalogProductRepository $repo = new CatalogProductRepository(),
    ...
    public function create(array $in): int
    {
        try {
            ...
            error_log('[CatalogProductService] ' . $ex->getMessage());
