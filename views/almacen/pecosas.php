<?php
/**
 * Vista principal del módulo PECOSA.
 *
 ...
 * @var array<int, array{norden:string, almacen:string, oficina:string, proveedor:string, total:float, fecha:string, estado:string, ano:string}> $pecosaRows
    ...
    <div class="col-12">
        <div class="d-flex flex-wrap justify-content-between align-items-end gap-3 py-1 px-1">
            <div>
                ...
                <h1 class="h3 fw-bold mb-1">PECOSA</h1>
                <p class="text-muted mb-0"><?= e($moduleLead ?? 'Consulta, registro y mantenimiento de PECOSA de almacén.') ?></p>
            </div>
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
                <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
                    <div>
                        <h2 class="h5 fw-semibold mb-1">Consulta de PECOSA</h2>
                        <p class="text-muted small mb-0">Filtros, resultados y acciones del comprobante de salida del almacén.</p>
                    </div>
                    <span class="badge text-bg-primary-subtle text-primary border border-primary-subtle">Endpoint /almacen/pecosas</span>
                </div>
            </div>

            <div class="card-body p-4">
                <form method="get" action="<?= e(url('/almacen/pecosas')) ?>" class="vstack gap-3">
                    <div class="row g-3">
                        <div class="col-md-2">
                    ...
                    <div class="d-flex flex-wrap gap-2 pt-2">
                        ...
                        <a href="<?= e(url('/almacen/pecosas')) ?>" class="btn btn-outline-secondary px-4">
                            <i class="bi bi-arrow-counterclockwise me-1"></i>Limpiar
                        </a>
                        <a href="#" class="btn btn-success px-4">
                            <i class="bi bi-plus-circle me-1"></i>Nueva PECOSA
                        </a>
                    </div>
                </form>
                ...
                <div class="row g-3 mt-4">
                    ...
                    <div class="col-md-4">
                        <div class="border rounded-4 p-3 bg-light h-100">
                            ...
                            <div class="display-6 fw-bold mb-0"><?= e(count($pecosaRows ?? [])) ?></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="border rounded-4 p-3 bg-light h-100">
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h3 class="h6 fw-bold mb-0">Relación de PECOSA</h3>
                        <span class="text-muted small">Listado principal del comprobante de salida</span>
                    </div>
                    ...
                    <div class="table-responsive rounded-4 border shadow-sm">
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                <?php if (!empty($pecosaRows)): ?>
                                    <?php foreach ($pecosaRows as $index => $row): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group" aria-label="Acciones PECOSA">
        ...
        <div class="vstack gap-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <div class="d-grid gap-2">
                        <a href="#" class="btn btn-outline-primary"><i class="bi bi-file-earmark-plus me-1"></i>Nueva PECOSA</a>
                        <a href="#" class="btn btn-outline-success"><i class="bi bi-pencil-square me-1"></i>Modificar PECOSA</a>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <div class="small text-muted mb-3">Pantallas y utilidades asociadas a la PECOSA.</div>
