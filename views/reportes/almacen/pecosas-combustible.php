...
<div class="card mb-4">
    <div class="card-header bg-primary text-white">REPORTE DE PECOSAS COMBUSTIBLES</div>
    <div class="card-body">
        <form method="get" class="row g-3 mb-3">
            ...
            <div class="col-auto">
                ...
                <input type="text" name="oficina" value="<?= e($filters['oficina'] ?? '') ?>" class="form-control" placeholder="Código">
            </div>
            <div class="col-auto">
                <label class="form-label">Almacén</label>
                <input type="text" name="almacen" value="<?= e($filters['almacen'] ?? '') ?>" class="form-control" placeholder="Código">
            </div>
